...
echo "🔍 DETECTING CURRENT GITHUB AUTHENTICATION"
echo "=========================================="

echo "Based on the error, you're currently authenticated as: SopheaktraTy"
echo ""

ACCOUNT="SopheaktraTy"
...
if git push -u origin main; then
    ...
    echo ""
    echo "7. Then run: ./push-current-account.sh"
    echo ""
    echo "💡 Check your account: https://github.com/$ACCOUNT"
    echo ""
    echo "🔄 OR switch to e20240751 account:"
    echo "   - Log out from GitHub"
    echo "   - Log in as e20240751"
    echo "   - Create repository"
    echo "   - Run: ./push-e20240751.sh"
fi
